...
- Fix: refresh recipe and deployment state when an update run finishes, clear stale update actions, show the installed source commit, and advance managed recipe patch versions on every successful repository update.
